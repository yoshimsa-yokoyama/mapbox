...
(function(){
	...
	function createImage(){
		var len = _imageList.length;
		for( var i = 0; i < len; i++ ){
			var _data = _imageList[i];
			var _x = _data.x;
			var _y = _data.y;
			var _t0 = _data.img0;
			var _t1 = _data.img1;
	...
	function createPlane(){
		...
		var _texture = new THREE.Texture( _mainCanvas );
 		_texture.needsUpdate = true; 
		var _mapHeight = new THREE.Texture( _subCanvas );
 		_mapHeight.needsUpdate = true; 
